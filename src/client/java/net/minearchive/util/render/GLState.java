...
/**
 * @link <a href="https://github.com/SimplexClient/Simplex-1.19/blob/master/src/main/java/tk/simplexclient/renderer/GLState.java">Github SimplexClient/Simplex-1.19...GLState.java</a>
 */
...
//        lastActiveTexture = GlStateManager._getActiveTexture();
...
//        GlStateManager._activeTexture(lastTexture);
//        glActiveTexture(lastActiveTexture);
        ...
        Arrays.stream(allCaps).forEach(it -> {
            if (capabilities.get(it)) glEnable(it);
            else glDisable(it);
        });
