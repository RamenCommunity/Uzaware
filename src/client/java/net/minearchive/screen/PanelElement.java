...
public class PanelElement implements IElement {
    ...
    public void render(DrawContext context, double mouseX, double mouseY, float delta, float offset) {
        NanoVGUtils.shadow(x, y, width, height - 5, 5, SimpleColor.of(0x40000000));
        NanoVGUtils.rounded(x, y, width, height - 5, 5, SimpleColor.of(0x99FFFFFF), NanoVGUtils.Pattern.FILL);
