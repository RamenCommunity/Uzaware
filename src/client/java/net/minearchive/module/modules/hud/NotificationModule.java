...
public class NotificationModule extends HudModule {
    ...
    public FloatSetting duration = add(new FloatSetting("InOut Duration", 600f, 100f, 1000));
    public FloatSetting keep = add(new FloatSetting("Keep Duration", 3500f, 10f, 5000));
